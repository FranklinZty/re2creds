mod tests{
    ...
    use halo2_poseidon::poseidon::{PoseidonInstructions, Pow5Chip, Pow5Config, StateWord};
   ...
   struct HashCircuit<
    ...
    fn poseidon_hash() {
        ...
        let k = 6;
        let circuit: HashCircuit<OrchardNullifier, 3, 2, 2> = HashCircuit::<OrchardNullifier, 3, 2, 2> {
